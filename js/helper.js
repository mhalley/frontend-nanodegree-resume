...
var HTMLbioPic = '<img src="%data%" alt="%alt%" class="biopic">';
...
var HTMLworkEmployer = ' - %data%</h4>';
var HTMLworkTitle = '<h4>%data%';
var HTMLworkDates = '— %data%</div>';
var HTMLworkLocation = '<div class="locationDate-text">%data% ';
...
var HTMLprojectImage = '<a href="#"><img src="%data%" alt="%alt%"></a>';

var HTMLschoolStart = '<div class="education-entry"></div>';
var HTMLschoolName = '<p>%data%</p>';
var HTMLschoolDegree = '<h4>%data% - ';
var HTMLschoolDates = ' — %data%</h4>';
var HTMLschoolLocation = '<div class="locationDate-text">%data%';
var HTMLschoolMajor = '%data%</div>';

var HTMLonlineClasses = '<div class="online-entry"><h3>Online Classes</h3></div>';
var HTMLonlineTitle = '<h4><a href="#">%data%</a>';
var HTMLonlineSchool = ' - %data%</h4>';
var HTMLonlineDates = '<div class="locationDate-text">%data%</div>';
